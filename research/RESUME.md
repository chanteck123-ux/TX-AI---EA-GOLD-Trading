...
7. Run the specified capital-capacity diagnostics, then freeze the normalized
   reference before S-C01. Its only variable is Scalping nearest valid zone
   distance. Intraday/Swing remain locked. No scalp profit protection.

...
Saved update: 2026-09-12 (Asia/Kuala_Lumpur). This edition retains the supplied risk-updated plan and incorporates the user's subsequent clarification on user-authored SOPs and autonomous optimization of other strategies.
...
- All 12 main sections are retained, with the SOP scope and execution entry points revised under §2.2 to reflect the user's subsequent clarification. Risk limits, broker and capital scope, test gates, identifiers, and dated historical status are unchanged by this clarification. The supplied source remains historical provenance; the current Chinese plan controls in the event of a translation ambiguity.
